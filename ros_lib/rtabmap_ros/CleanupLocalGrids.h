...
static const char CLEANUPLOCALGRIDS[] = "rtabmap_ros/CleanupLocalGrids";
  ...
  class CleanupLocalGridsRequest : public ros::Msg
  {
    ...
    const char * getType(){ return CLEANUPLOCALGRIDS; };
    const char * getMD5(){ return "f7e9883a6b75c0ecc1bb1c33f3332f61"; };
  ...
  class CleanupLocalGridsResponse : public ros::Msg
  {
    ...
    const char * getType(){ return CLEANUPLOCALGRIDS; };
    const char * getMD5(){ return "0079be4fbca49cb5090f065d768dbb2c"; };
